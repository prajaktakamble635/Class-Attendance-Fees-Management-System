          ...
          <nav>
            ...
            {expandedSections.exam && (
              <ul className="mb-2 flex flex-col gap-0.5">
                <NavItem
                  to="/batchCoord/hall-ticket"
                  icon={IdCard}
                  label="Hall Ticket"
                />
                <NavItem
                  to="/batchCoord/attendance-sheet"
                  icon={ClipboardList}
                  label="Attendance Sheet"
                />
                <NavItem
                  to="/batchCoord/marks-entry"
                  icon={BarChart3}
                  label="Marks Entry"
                />
              </ul>
            ...
            {expandedSections.reports && (
              <ul className="mb-2 flex flex-col gap-0.5">
                <NavItem
                  to="/batchCoord/report-card"
                  icon={FileCheck}
                  label="Report Card"
                />
                <NavItem
                  to="/batchCoord/reports"
                  icon={BarChart3}
                  label="Reports"
                />
              </ul>
...
StaffSidenav.defaultProps = {};

StaffSidenav.displayName = "/src/widgets/layout/staff-sidenav";
