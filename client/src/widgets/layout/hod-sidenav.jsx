          ...
          <nav>
            ...
            {expandedSections.main && (
              <ul className="mb-2 flex flex-col gap-0.5">
                <NavItem
                  to="/hod/add-admission"
                  icon={UserPlus}
                  label="Admission"
                />
                <NavItem to="/hod/view-all-student-fees" icon={Banknote} label="Fees" />
              </ul>
            )}

            {/* Examination Section */}
            <SectionHeader title="Examination" sectionKey="exam" />
            ...
            {/* Reports Section */}
            <SectionHeader title="Reports & Analytics" sectionKey="reports" />
...
HodSidenav.defaultProps = {};

HodSidenav.displayName = "/src/widgets/layout/hod-sidenav";

export default HodSidenav;
