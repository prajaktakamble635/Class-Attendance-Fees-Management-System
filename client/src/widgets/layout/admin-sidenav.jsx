          ...
          <nav>
            ...
            {user?.userRole === 1 && (
              <ul className="flex flex-col gap-0.5 mt-0.5">
                ...
                />
                <NavItem
                  to="/superAdmin/daily-attendance"
                  icon={ClipboardList}
            ...
            {expandedSections.main && (
              <ul className="mb-2 flex flex-col gap-0.5">
                <NavItem
                  to="/superAdmin/add-admission"
                  icon={UserPlus}
                  label="Admission"
                />
                <NavItem to="/superAdmin/view-all-student-fees" icon={Banknote} label="Fees" />
              </ul>
            )}
            ...
            {expandedSections.exam && (
              <ul className="mb-2 flex flex-col gap-0.5">
                ...
                />
                <NavItem
                  to="/superAdmin/hall-ticket"
                  icon={IdCard}
                  label="Hall Ticket"
                />
                <NavItem
                  to="/superAdmin/attendance-sheet"
                  icon={ClipboardList}
                  label="Attendance Sheet"
                />
                <NavItem
                  to="/superAdmin/marks-entry"
                  icon={BarChart3}
                  label="Marks Entry"
                />
              </ul>
