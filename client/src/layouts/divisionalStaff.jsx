...
import DivisionalStaffRoutesLinks from "@/divisional-staff-routes-links.jsx";
import DivisionalStaffSidenav from "@/widgets/layout/divisional-staff-sidenav.jsx";

export function DivisionalStaff() {
        ...
        <div className="min-h-screen bg-gray-200 dark:bg-gradient-to-br from-blue-gray-500 to-blue-gray-700">
           <img
            ...
            <div
                ...
                <Configurator />
                <Routes>
                    {DivisionalStaffRoutesLinks.map(
                        ({ layout, pages }) =>
                            layout === "divisionalStaff" &&
...
DivisionalStaff.displayName = "/src/layout/divisionalStaff";

export default DivisionalStaff;
