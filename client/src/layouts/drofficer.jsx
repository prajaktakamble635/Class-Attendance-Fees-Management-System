...
import DrofficerSidenav from "@/widgets/layout/drofficer-sidenav";
import drofficerRoutes from "@/drofficer-routes-links";

export function Drofficer() {
...
Drofficer.displayName = "/src/layout/drofficer";

export default Drofficer;
