            ...
            <div className="flex flex-col justify-between md:flex-row">
              ...
              <div className="flex flex-col gap-2 md:flex-row">
                ...
                <div className="flex flex-row gap-2">
                  <Button
                    onClick={() => navigate("/counsellor/admission-import")}
                  ...
                  <Button
                    onClick={() => navigate("/counsellor/add-admission")}
                    className="inline-flex self-center"
                    variant="outlined"
                    color="white"
                    size="sm"
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr key={rowObj.id}>
                    <td className="items-center border-b border-blue-gray-50 px-2 py-2">
                      <div className="flex flex-row gap-3">
                        ...
                        <Tooltip content="edit" className="p-1 text-xs">
                          <Link to={`/counsellor/edit-student/${rowObj.id}`}>
                    ...
                    <td onClick={() => navigate(`/counsellor/edit-student/${rowObj.id}`)} className="items-center hover:cursor-pointer border-b border-blue-gray-50 px-2 py-2">
                      <div className="flex flex-row gap-3">
                        <Typography className="text-xs font-semibold text-blue-gray-600">
                          {rowObj?.rollNo || ""}
                        </Typography>
