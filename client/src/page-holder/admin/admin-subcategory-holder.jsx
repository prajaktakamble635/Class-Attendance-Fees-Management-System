...
export default function SubCategoryHolder() {
  ...
  React.useEffect(() => {
    document.title = "SproutEdge Agro - SubCategories";
  ...
  const getTableRecordByPage = (
    ...
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/subCategoryApi/getAllSubCategories`, {
        currentPage,
        perPage,
        orderBy,
        orderDirection,
        ...
        categoryIdFk: categoryIdFk || undefined,
      })
      .then((response) => {
        if (response.status === 200) {
  ...
  const changeStatus = (id, value) => {
    ...
    }/api/subCategoryApi/changeSubCategoryStatus`;
    axios
  ...
  const handleDeleteSubCategory = async (id) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/subCategoryApi/deleteSubCategory`,
        { id }
      );
      if (response.status === 200) {
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-col justify-between md:flex-row">
              ...
              <div className="flex flex-col gap-2 md:flex-row">
                ...
                {/* <div className="w-48 rounded-md border-0 bg-white">
                  <Select
                    label="Filter by Category"
                    value={tableProp.categoryIdFk}
                ...
                {tableData && tableData.length === 0 ? (
                  ...
                  tableData.map((rowObj, key) => (
                    <tr key={rowObj.id}>
                      ...
                      <TableCell
                        text={rowObj?.categoryName || "Uncategorized"}
                      />
