...
export default function AddCategoryHolder() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      submitData.append('forInternational', formData.forInternational ? 1 : 0);
      submitData.append('forDomestic', formData.forDomestic ? 1 : 0);
      submitData.append('forLocal', formData.forLocal ? 1 : 0);
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/categoryApi/createCategory`,
        submitData,
        {
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-lg bg-green-50 p-6">
                ...
                <Typography variant="small" className="mb-4 text-gray-600">
                  Select which markets this category should be visible in
                </Typography>
              ...
              <div className="rounded-lg bg-purple-50 p-6">
                ...
                <Typography variant="small" className="mb-4 text-gray-600">
                  Upload category images for different purposes. Images will be
