...
export default function WarehouseHolder() {
  ...
  React.useEffect(() => {
    document.title = "SproutEdge Agro - Warehouses";
  ...
  const getTableRecordByPage = (
    ...
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/warehouseApi/getAllWarehouses`, {
        currentPage,
        perPage,
        orderBy,
        orderDirection,
  ...
  const changeStatus = (id, value) => {
    ...
    }/api/warehouseApi/changeWarehouseStatus`;
    axios
  ...
  const handleDeleteWarehouse = async (id) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/warehouseApi/deleteWarehouse`,
        { id }
      );
      if (response.status === 200) {
            ...
            <div className="flex flex-col justify-between md:flex-row">
              ...
              <div className="flex flex-col gap-2 md:flex-row">
                ...
                <div className="flex flex-row gap-2">
                  <Button
                    onClick={() => navigate("/admin/add-warehouse")}
                ...
                {tableData && tableData.length === 0 ? (
                  ...
                  tableData.map((rowObj, key) => (
                    <tr key={rowObj.id}>
                      ...
                      <TableCell text={rowObj?.contactPerson || "--"} />
