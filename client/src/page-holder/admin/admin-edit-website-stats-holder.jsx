...
export default function EditWebsiteStatsHolder() {
  ...
  useEffect(() => {
    document.title = "SproutEdge Agro - Edit Website Stats";
    getWebsiteStatsData();
  }, [id]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/websiteStatsApi/updateWebsiteStat`,
        {
          id: Number(id),
      ...
      if (response.status === 200) {
        toast.success("Website Stats updated successfully.", {
        ...
        <CardBody className="bg-white from-blue-gray-700 to-blue-gray-800 dark:bg-gradient-to-br">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              >
                {isSubmitting ? "Updating..." : "Update Website Stats"}
              </Button>
            </div>
          </form>
        </CardBody>
